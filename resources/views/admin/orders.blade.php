            ...
            <div class="p-5 space-y-3">
                ...
                <div class="mt-3 p-3 bg-slate-50 rounded-xl border border-slate-200">
                    <p class="text-sm text-slate-700 mb-2">
                        ...
                        <a href="tel:{{ $order->phone }}" class="text-brand-600 hover:text-brand-700">{{ $order->phone }}</a>
                    </p>
                    @if($order->comment)
                    <p class="text-sm text-slate-700"><span class="font-semibold">Комментарий:</span> {{ $order->comment }}</p>
                    @endif
                </div>
            </div>
