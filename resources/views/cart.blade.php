        ...
        <div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
            <div class="flex items-center justify-between h-14 sm:h-16 gap-2">
                ...
                <a href="{{ route('menu') }}" class="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                    <div class="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-brand-500 to-brand-600 rounded-xl flex items-center justify-center">
                    ...
                    <span class="text-lg sm:text-xl font-bold text-stone-900 hidden sm:inline">Barakad</span>
                </a>
